"""
Genera tabla comparativa 2021 vs 2024 con 4 escenarios - SIN TOPES
Igual que tmp_generar_tabla_4_escenarios.py pero con aplicar_topes=False
"""
import pandas as pd
...
def generar_tabla_comparativa():
    """
    Genera tabla con 4 escenarios comparando 2021 vs 2024 - SIN TOPES
    """
    print("=" * 80)
    ...
    print("  - SIN TOPES (ni sobrerrepresentacion ni limite de 300)")
        ...
        for anio in [2021, 2024]:
            ...
            try:
                ...
                resultado = procesar_diputados_v2(
                    ...
                    umbral=0.03,  # 3% umbral SI se mantiene
