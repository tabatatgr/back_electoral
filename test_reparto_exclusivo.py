...
def test_sistema_reparto_exclusivo():
    ...
    try:
        resultado_cuota = procesar_diputados_v2(
            **config_base,
            quota_method="hare",
            divisor_method=None  # ⬅️ DEBE SER None cuando usas cuota
        )
    ...
    try:
        resultado_divisor = procesar_diputados_v2(
            **config_base,
            quota_method=None,  # ⬅️ DEBE SER None cuando usas divisor
    ...
    try:
        if resultado_cuota and resultado_divisor:
            ...
            if cambios_detectados:
                ...
                print()
                print("   ⚠️  IGUALES: Los métodos producen resultados idénticos")
