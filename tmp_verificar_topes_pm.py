...
df = pd.read_csv('outputs/comparativa_2021_vs_2024_CORREGIDO_20260106_134722.csv')
...
for _, row in morena_2024.iterrows():
    ...
    excede = total > 201
    print(f"{row['Escenario']}: MR={row['MR']}, PM={row['PM']}, RP={row['RP']}, Total={total}, Tope=201, {'⚠️ EXCEDE' if excede else '✓ OK'}")
